...
class Oblogout(MenuMaker.Menu) :
        name = "Oblogout"
        def __init__(self) :
 	        subs = [
			X('<menu id="client-list-menu"/>'),
                        X('<item label="Sesion"> <action name="Execute"> <execute> sudo oblogout </execute> </action> </item>'),
                        X('<item label="Reiniciar"> <action name="Execute"> <prompt> Seguro que quieres reiniciar?  </prompt> <execute> sudo shutdown -r now </execute> </action> </item>'),
                        X('<item label="Apagar"> <action name="Execute"> <prompt> Seguro que quieres apagar?  </prompt> <execute> sudo shutdown -h now </execute> </action> </item>'),
                ]
                super(Oblogout, self).__init__(subs)
		self.align = MenuMaker.Entry.StickBottom
